...
struct FttData
{
    ...
    Float_t    stripcenter[FTT_MAX_HITS];
    ...
    Float_t    cMaxAdc_Pos[FTT_MAX_CLUSTERS];
    Float_t    cMaxADC_LEdge[FTT_MAX_CLUSTERS];
    Float_t    cMaxADC_REdge[FTT_MAX_CLUSTERS];
    ...
    Float_t  pDiag1[FTT_MAX_POINTS];
    Float_t  pDiag2[FTT_MAX_POINTS];

...
public:
    ...
    **/
    ...
    void setMapping( UChar_t mPlane, UChar_t mQuadrant, UChar_t mRow, UChar_t mStrip, Float_t StripCenter, UChar_t mOrientation );
    
    //Zhen add it. for the strip edge
    void setStripEdge( Float_t mStrip_LEdge, Float_t mStrip_REdge );
    ...
    UChar_t row() const;
    UChar_t strip() const;
    Float_t strip_center() const;
    Float_t strip_LEdge() const;
    Float_t strip_REdge() const;
...
protected:
    ...
    UChar_t mRow;
    UChar_t mStrip;
    Float_t mStrip_center; 
    Float_t mStrip_LEdge;
    Float_t mStrip_REdge;
...
inline Float_t  StFttRawHit::strip_center()     const { return mStrip_center;};
inline Float_t  StFttRawHit::strip_LEdge()      const { return mStrip_LEdge; };
inline Float_t  StFttRawHit::strip_REdge()      const { return mStrip_REdge; };

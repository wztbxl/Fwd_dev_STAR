...
public:
    ...
    int Idx_MaxStrip() const;
    float SC_MaxStrip() const;
    float MaxStripLEdge() const;
    float MaxStripREdge() const;
    ...
    void setIdx_MaxStrip(int index);
    void setSC_MaxStrip(float sc);
    void setMaxStripLEdge(float LEdge);
    void setMaxStripREdge(float REdge);
...
private:
    ...
    Int_t mNStrips=-999;         // Number of strips
    Float_t mSumAdc=-999;      // Total ADC (0th moment)
    ...
    Int_t mIdx_MaxStrip = -999;// index of the strip with maximum ADC
    Float_t mSC_MaxStrip = -999;// Strip center of strip with maximum ADC
    Float_t mMaxStripLEdge = -999;//left edge of the strip with maximum ADC
    Float_t mMaxStripREdge = -999;//right edge of the strip with maximum ADC
...
inline int StFttCluster::Idx_MaxStrip() const { return mIdx_MaxStrip; } 
inline float StFttCluster::SC_MaxStrip() const { return mSC_MaxStrip; } 
inline float StFttCluster::MaxStripLEdge() const { return mMaxStripLEdge; } 
inline float StFttCluster::MaxStripREdge() const { return mMaxStripREdge; } 
...
inline void StFttCluster::setIdx_MaxStrip( int index ) { mIdx_MaxStrip = index; }
inline void StFttCluster::setSC_MaxStrip( float sc ) { mSC_MaxStrip = sc; }
inline void StFttCluster::setMaxStripLEdge( float LEdge ) { mMaxStripLEdge = LEdge; }
inline void StFttCluster::setMaxStripREdge( float REdge ) { mMaxStripREdge = REdge; }

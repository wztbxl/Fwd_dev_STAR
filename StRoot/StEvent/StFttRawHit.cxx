...
void StFttRawHit::setMapping(   UChar_t mPlane, UChar_t mQuadrant, 
                                UChar_t mRow, UChar_t mStrip, Float_t StripCenter, UChar_t mOrientation ){
    this->mPlane       = mPlane;
    this->mQuadrant    = mQuadrant;
    this->mRow         = mRow;
    this->mStrip       = mStrip;
    this->mStrip_center= StripCenter;
    this->mOrientation = mOrientation;
}

void StFttRawHit::setStripEdge( Float_t mStrip_LEdge, Float_t mStrip_REdge )
{
    this->mStrip_LEdge    = mStrip_LEdge;
    this->mStrip_REdge    = mStrip_REdge;
}

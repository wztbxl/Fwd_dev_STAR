...
private:
    ...
    //8 functions to check the (x,y) in or no in the real strip gourp
    // inline bool StFttPointMaker::is_Group1(double x, double y) const { return ( (14.60 <= x && x <= 172.29) && (14.60 <= y && y <= 172.29) ); }
    // inline bool StFttPointMaker::is_Group2(double x, double y) const { return ( (172.29 <= x && x <= 360.09) && (14.60 <= y && y <= 172.29) ); }
    // inline bool StFttPointMaker::is_Group3(double x, double y) const 
    // { 
    //     return ( ( (360.09 <= x && x <= 504.2) && (14.60 <= y && y <= 172.29) ) || ( (504.2<= x && x <= 548.3) && (14.60 <= y && y <= 216.89) ) );
    // }
    // inline bool StFttPointMaker::is_Group4(double x, double y) const { return ( (14.60 <= x && x <= 172.29) && (172.29 <= y && y <= 360.09) ); }
    // inline bool StFttPointMaker::is_Group5(double x, double y) const 
    // {
    //     return ( ((172.29 <= x && x <= 315.4) && (172.29 <= y && y <= 360.09)) || ((315.4 <= x && x <= 360.09) && (172.29 <= y && y <= 410.9)) || ((360.09 <= x && x <= 410.9) && (315.4 <= y && y <= 410.9)) );
    // }
    // inline bool StFttPointMaker::is_Group6(double x, double y) const { return ((360.09 <= x && x <= 504.2) && (172.29 <= y && y <= 315.4)); }
    // inline bool StFttPointMaker::is_Group7(double x, double y) const 
    // { 
    //     return ( ( (360.09 <= y && y <= 504.2) && (14.60 <= x && x <= 172.29) ) || ( (504.2<= y && y <= 548.3) && (14.60 <= x && x <= 216.89) ) );
    // }
    // inline bool StFttPointMaker::is_Group8(double x, double y) const { return ((360.09 <= y && y <= 504.2) && (172.29 <= x && x <= 315.4)); }

    // try to fix the "extra qualification" warning

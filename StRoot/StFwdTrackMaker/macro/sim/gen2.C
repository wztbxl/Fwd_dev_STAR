...
void trig( Int_t n=1 )
{
  ...
  for ( Int_t i=0; i<n; i++ ) {
    ...
    kinematics->Kine( numParticles, nameParticle.Data(), 10.0, 50.0, 2.5, 4.00, 3.14159265, 1.5 * 3.14159265  );
...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
void gen2( Int_t nevents=2000, Int_t rngSeed=1234 )
{ 
  ...
  {
    TString simple = "dev2022 geant gstar usexgeom agml ";
    bfc(0, simple );
  }
